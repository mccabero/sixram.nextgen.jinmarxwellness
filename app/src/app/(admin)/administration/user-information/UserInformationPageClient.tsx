...
import { KeyRound, Pencil, Search, Shield, UserRound, UsersRound } from "lucide-react";
...
function getStatusTone(user: UserInformationRow) {
...
export function UserInformationPageClient() {
  ...
  const filteredUsers = useMemo(() => {
    if (!deferredSearch) {
      return userInformationRows;
    }

    return userInformationRows.filter((user) => {
  ...
  function openUser(user: UserInformationRow) {
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-[var(--color-muted)]">
                This follows the GoldSuite list-first user management pattern.
              </p>
            </div>
          </div>
